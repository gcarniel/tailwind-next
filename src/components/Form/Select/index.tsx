    ...
    <SelectPrimitive.Root {...props}>
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          ...
          position="popper"
          sideOffset={8}
          className="z-10 w-[--radix-select-trigger-width] overflow-hidden rounded-lg border border-zinc-200 bg-white animate-slideDownAndFade dark:border-zinc-700 dark:bg-zinc-800"
        >
